...
public final class ReflectionUtils {
  ...
  public static <T> void forEachInArray(@Nonnull Object array, @Nonnull Consumer<T> action) {
	...
	/**
	 * @see #forEachInArray(Object, Consumer)
	 */
  public static <T> void forEachInArray(@Nonnull Object array, @Nonnull BiConsumer<? super Integer, T> action) {
    ArrayWalker.<T>walkObject(array).forEach(action);
  }
  ...
  public static <T> T getFieldValueOrNull(@Nonnull Object instance, @Nullable String name) {
    try {
      if (name == null) return null;
      Field field = getInheritedPrivateField(instance.getClass(), name);
      if (!field.isAccessible()) field.setAccessible(true);
  ...
  public static <T> T invokeMethodOrNull(@Nonnull Object instance, @Nonnull String method) {
    try {
      return invokeMethodOrNull(instance, getInheritedPrivateMethod(instance.getClass(), method));
