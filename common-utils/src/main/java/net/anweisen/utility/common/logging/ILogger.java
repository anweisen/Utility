...
import net.anweisen.utility.common.logging.internal.FallbackLogger;
import net.anweisen.utility.common.logging.internal.JavaLoggerWrapper;
import net.anweisen.utility.common.logging.internal.SimpleLogger;
import net.anweisen.utility.common.logging.internal.Slf4jLoggerWrapper;
import net.anweisen.utility.common.logging.internal.factory.ConstantLoggerFactory;
import net.anweisen.utility.common.logging.internal.factory.DefaultLoggerFactory;
import net.anweisen.utility.common.logging.internal.factory.Slf4jLoggerFactory;
import net.anweisen.utility.common.logging.lib.JavaILogger;
import net.anweisen.utility.common.logging.lib.Slf4jILogger;
...
public interface ILogger {
	...
	default void fatal(@Nullable String message, @Nonnull Object... args) {
		log(LogLevel.FATAL, message, args);
	}

	default void fatal(@Nullable Object message, @Nonnull Object... args) {
		log(LogLevel.FATAL, message, args);
	}
