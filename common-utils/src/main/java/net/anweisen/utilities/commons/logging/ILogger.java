...
import net.anweisen.utilities.commons.logging.internal.FallbackLogger;
...
import net.anweisen.utilities.commons.logging.internal.Slf4jLoggerWrapper;
import net.anweisen.utilities.commons.logging.internal.factory.DefaultLoggerFactory;
import net.anweisen.utilities.commons.logging.internal.factory.Slf4jLoggerFactory;
...
public interface ILogger {
	...
	default org.slf4j.Logger slf4j() {
		if (this instanceof org.slf4j.Logger)
			return (org.slf4j.Logger) this;
		throw new IllegalStateException(this.getClass().getName() + " does not implement or support org.slf4j.Logger");
	}
