package net.anweisen.utility.jda.manager.impl.slashcommands;

import net.anweisen.utility.common.collection.StringBuilderPrintWriter;
...
import net.anweisen.utility.jda.manager.impl.slashcommands.build.IBaseCommandData;
import net.anweisen.utility.jda.manager.impl.slashcommands.build.ICommandData;
import net.anweisen.utility.jda.manager.impl.slashcommands.build.ISubcommandData;
import net.anweisen.utility.jda.manager.impl.slashcommands.build.ISubcommandGroupData;
