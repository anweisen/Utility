...
import net.anweisen.utility.bukkit.utils.wrapper.ActionListener;
import net.anweisen.utility.bukkit.utils.wrapper.SimpleEventExecutor;
import net.anweisen.utility.common.annotations.DeprecatedSince;
...
public abstract class BukkitModule extends JavaPlugin {
	...
	@Nonnull
	public Storable getConfig(@Nonnull String filename) {
