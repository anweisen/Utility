package net.anweisen.utilities.jda.commandmanager.examples;

import net.anweisen.utilities.database.SQLColumn;
import net.anweisen.utilities.database.SQLColumn.Type;
import net.anweisen.utilities.jda.commandmanager.defaults.commands.DefaultSetPrefixCommand;
import net.anweisen.utilities.jda.commandmanager.bot.DiscordBot;
import net.anweisen.utilities.jda.commandmanager.bot.DiscordBotBuilder;
...
public class DiscordBotExample extends DiscordBot {
	...
	protected DiscordBotBuilder builder() {
		return newBuilder() // Shortcut for new DiscordBotBuilder()
				...
				.resourceLanguages("en.json") // Read hardcoded languages from resources
											  // You should use language files which are set in the config and can be edited without rebuilding this project
				.fileLanguages("en.json") // Read languages from files
